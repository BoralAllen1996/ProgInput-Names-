...
label = Label(window, textvariable=equation_label, font=('arial',20), bg="cadetblue",width=24, height=2)
label.pack()

frame = Frame(window, bd=20, pady=2, bg="cadetblue", relief=RIDGE)
frame.pack()
