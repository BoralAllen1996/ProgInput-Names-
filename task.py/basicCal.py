...
root = Tk()
blank_space = " "
root.title (50 * blank_space + "Allen Code Calculation")
...
btnClear = Button(MainFrame, width=6, height=2,font=('arial',16,'bold'), bd=4, text=chr(67)+chr(69),bg='cadetblue', command= added_value.clear_Entry)
...
btnSq = Button(MainFrame, width=6, height=2,font=('arial',16,'bold'), bd=4, text="V",  command= added_value.squared)
...
btnMult = Button(MainFrame, width=6, height=2,font=('arial',16,'bold'), bd=4, text="*", bg='cadetblue', command =lambda:added_value.operation("mult"))
...
btnZero = Button(MainFrame, width=6, height=2,font=('arial',16,'bold'), bd=4, text="0", bg='cadetblue', command =lambda:added_value.numberEnter("0"))
btnZero.grid(row=6, column=0, pady=1)

btnDot = Button(MainFrame, width=6, height=2,font=('arial',16,'bold'), bd=4, text=".", bg='cadetblue', command =lambda:added_value.numberEnter("."))
